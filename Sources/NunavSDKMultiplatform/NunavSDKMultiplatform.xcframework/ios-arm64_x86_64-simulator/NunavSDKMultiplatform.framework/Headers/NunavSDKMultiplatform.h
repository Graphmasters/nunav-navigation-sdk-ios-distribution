...
@property (readonly) NSDKMCameraUpdate * _Nullable cameraUpdate __attribute__((swift_name("cameraUpdate")));
...
- (instancetype)initWithApiKey:(NSString *)apiKey serviceUrl:(NSString *)serviceUrl __attribute__((swift_name("init(apiKey:serviceUrl:)"))) __attribute__((objc_designated_initializer));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)requestRouteRouteRequest:(NSDKMRouteProviderRouteRequest *)routeRequest completionHandler:(void (^)(NSDKMRoute * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("requestRoute(routeRequest:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)requestRouteDataOrigin:(NSDKMLatLng *)origin destination:(NSDKMLatLng *)destination vehicleConfig:(id<NSDKMVehicleConfig>)vehicleConfig completionHandler:(void (^)(NSDKMRouteData * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("requestRouteData(origin:destination:vehicleConfig:completionHandler:)")));
@end
...
@interface NSDKMIOException : NSDKMKotlinException
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
@property (readonly) int32_t statusCode __attribute__((swift_name("statusCode")));
@property (readonly) NSString *url __attribute__((swift_name("url")));
- (instancetype)initWithStatusCode:(int32_t)statusCode description:(NSString *)description url:(NSString *)url exception:(NSDKMKotlinException * _Nullable)exception __attribute__((swift_name("init(statusCode:description:url:exception:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TooManyRequestsException")))
@interface NSDKMTooManyRequestsException : NSDKMKotlinException
- (instancetype)initWithMessage:(NSString *)message exception:(NSDKMKotlinException * _Nullable)exception __attribute__((swift_name("init(message:exception:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(NSDKMKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@interface NSDKMUnauthorizedException : NSDKMKotlinException
- (instancetype)initWithMessage:(NSString *)message exception:(NSDKMKotlinException * _Nullable)exception __attribute__((swift_name("init(message:exception:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FallbackRouteProvider")))
@interface NSDKMFallbackRouteProvider : NSDKMBase <NSDKMRouteProvider>
- (instancetype)initWithRouteProvider:(id<NSDKMRouteProvider>)routeProvider __attribute__((swift_name("init(routeProvider:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithRouteProvider:(id<NSDKMRouteProvider>)routeProvider timeout:(NSDKMDuration *)timeout __attribute__((swift_name("init(routeProvider:timeout:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) NSDKMRouteProviderRouteRequest *routeRequest __attribute__((swift_name("routeRequest")));
- (instancetype)initWithMessage:(NSString *)message routeRequest:(NSDKMRouteProviderRouteRequest *)routeRequest exception:(NSDKMKotlinException * _Nullable)exception __attribute__((swift_name("init(message:routeRequest:exception:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(NSDKMKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
@interface NSDKMAppInfo : NSDKMBase
@property (class, readonly, getter=shared) NSDKMAppInfo *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *bundleIdentifier __attribute__((swift_name("bundleIdentifier")));
...
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)appInfo __attribute__((swift_name("init()")));
@end
...
@interface NSDKMDeviceInfo : NSDKMBase
@property (class, readonly, getter=shared) NSDKMDeviceInfo *shared __attribute__((swift_name("shared")));
...
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) NSString *systemName __attribute__((swift_name("systemName")));
@property (readonly) NSString *systemVersionName __attribute__((swift_name("systemVersionName")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)deviceInfo __attribute__((swift_name("init()")));
@end
...
@property (readonly) NSDKMNavigationUIStateNavigationErrorType *type __attribute__((swift_name("type")));
- (instancetype)initWithException:(NSDKMKotlinException *)exception type:(NSDKMNavigationUIStateNavigationErrorType *)type critical:(BOOL)critical __attribute__((swift_name("init(exception:type:critical:)"))) __attribute__((objc_designated_initializer));
- (NSDKMNavigationUIStateNavigationError *)doCopyException:(NSDKMKotlinException *)exception type:(NSDKMNavigationUIStateNavigationErrorType *)type critical:(BOOL)critical __attribute__((swift_name("doCopy(exception:type:critical:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NavigationUIState.NavigationErrorType")))
@interface NSDKMNavigationUIStateNavigationErrorType : NSDKMKotlinEnum<NSDKMNavigationUIStateNavigationErrorType *>
@property (class, readonly) NSDKMNavigationUIStateNavigationErrorType *noRouteFound __attribute__((swift_name("noRouteFound")));
@property (class, readonly) NSDKMNavigationUIStateNavigationErrorType *unauthorized __attribute__((swift_name("unauthorized")));
@property (class, readonly) NSDKMNavigationUIStateNavigationErrorType *unknown __attribute__((swift_name("unknown")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (NSDKMKotlinArray<NSDKMNavigationUIStateNavigationErrorType *> *)values __attribute__((swift_name("values()")));
@end
...
- (NSDKMLength *)abs __attribute__((swift_name("abs()")));
...
+ (void)Skie_Suspend__0__requestRouteDispatchReceiver:(id<NSDKMRouteProvider>)dispatchReceiver routeRequest:(NSDKMRouteProviderRouteRequest *)routeRequest suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__0__requestRoute(dispatchReceiver:routeRequest:suspendHandler:)")));
+ (void)Skie_Suspend__1__requestRouteDataDispatchReceiver:(id<NSDKMRouteProvider>)dispatchReceiver origin:(NSDKMLatLng *)origin destination:(NSDKMLatLng *)destination vehicleConfig:(id<NSDKMVehicleConfig>)vehicleConfig suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__1__requestRouteData(dispatchReceiver:origin:destination:vehicleConfig:suspendHandler:)")));
+ (void)Skie_Suspend__2__hasNextDispatchReceiver:(NSDKMSkieColdFlowIterator<id> *)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__2__hasNext(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__3__collectDispatchReceiver:(id<NSDKMKotlinx_coroutines_coreFlow>)dispatchReceiver collector:(id<NSDKMKotlinx_coroutines_coreFlowCollector>)collector suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__3__collect(dispatchReceiver:collector:suspendHandler:)")));
+ (void)Skie_Suspend__4__emitDispatchReceiver:(id<NSDKMKotlinx_coroutines_coreFlowCollector>)dispatchReceiver value:(id _Nullable)value suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__4__emit(dispatchReceiver:value:suspendHandler:)")));
+ (void)Skie_Suspend__5__executeDispatchReceiver:(id<NSDKMKtor_client_coreHttpClientEngine>)dispatchReceiver data:(NSDKMKtor_client_coreHttpRequestData *)data suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__5__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__6__writeToDispatchReceiver:(NSDKMKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<NSDKMKtor_ioByteWriteChannel>)channel suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__6__writeTo(dispatchReceiver:channel:suspendHandler:)")));
+ (void)Skie_Suspend__7__upgradeDispatchReceiver:(NSDKMKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<NSDKMKtor_ioByteReadChannel>)input output:(id<NSDKMKtor_ioByteWriteChannel>)output engineContext:(id<NSDKMKotlinCoroutineContext>)engineContext userContext:(id<NSDKMKotlinCoroutineContext>)userContext suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__7__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__8__executeDispatchReceiver:(NSDKMKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__8__execute(dispatchReceiver:context:subject:suspendHandler:)")));
+ (void)Skie_Suspend__9__awaitContentDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__9__awaitContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__10__discardDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver max:(int64_t)max suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__10__discard(dispatchReceiver:max:suspendHandler:)")));
+ (void)Skie_Suspend__11__peekToDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver destination:(NSDKMKtor_ioMemory *)destination destinationOffset:(int64_t)destinationOffset offset:(int64_t)offset min:(int64_t)min max:(int64_t)max suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__11__peekTo(dispatchReceiver:destination:destinationOffset:offset:min:max:suspendHandler:)")));
+ (void)Skie_Suspend__12__readAvailableDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver dst:(NSDKMKtor_ioChunkBuffer *)dst suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__12__readAvailable(dispatchReceiver:dst:suspendHandler:)")));
...
+ (void)Skie_Suspend__16__readBooleanDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__16__readBoolean(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__17__readByteDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__17__readByte(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__18__readDoubleDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__18__readDouble(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__19__readFloatDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__19__readFloat(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__20__readFullyDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver dst:(NSDKMKtor_ioChunkBuffer *)dst n:(int32_t)n suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__20__readFully(dispatchReceiver:dst:n:suspendHandler:)")));
...
+ (void)Skie_Suspend__23__readFullyDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver dst:(void *)dst offset:(int64_t)offset length:(int64_t)length suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__23__readFully(dispatchReceiver:dst:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__24__readIntDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__24__readInt(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__25__readLongDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__25__readLong(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__26__readPacketDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver size:(int32_t)size suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__26__readPacket(dispatchReceiver:size:suspendHandler:)")));
+ (void)Skie_Suspend__27__readRemainingDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver limit:(int64_t)limit suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__27__readRemaining(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__28__readShortDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__28__readShort(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__29__readSuspendableSessionDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver consumer:(id<NSDKMKotlinSuspendFunction1>)consumer suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__29__readSuspendableSession(dispatchReceiver:consumer:suspendHandler:)")));
+ (void)Skie_Suspend__30__readUTF8LineDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver limit:(int32_t)limit suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__30__readUTF8Line(dispatchReceiver:limit:suspendHandler:)")));
+ (void)Skie_Suspend__31__readUTF8LineToDispatchReceiver:(id<NSDKMKtor_ioByteReadChannel>)dispatchReceiver out:(id<NSDKMKotlinAppendable>)out limit:(int32_t)limit suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__31__readUTF8LineTo(dispatchReceiver:out:limit:suspendHandler:)")));
+ (void)Skie_Suspend__32__awaitFreeSpaceDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__32__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__33__writeAvailableDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(NSDKMKtor_ioChunkBuffer *)src suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__33__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__34__writeAvailableDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(NSDKMKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__34__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__35__writeAvailableDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__35__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__36__writeAvailableDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__36__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__37__writeByteDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__37__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__38__writeDoubleDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__38__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__39__writeFloatDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__39__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__40__writeFullyDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver memory:(NSDKMKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__40__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__41__writeFullyDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(NSDKMKtor_ioBuffer *)src suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__41__writeFully(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__42__writeFullyDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(NSDKMKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__42__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__43__writeFullyDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__43__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__44__writeFullyDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__44__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__45__writeIntDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__46__writeLongDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__writeLong(dispatchReceiver:l:suspendHandler:)")));
+ (void)Skie_Suspend__47__writePacketDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver packet:(NSDKMKtor_ioByteReadPacket *)packet suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__48__writeShortDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__49__writeSuspendSessionDispatchReceiver:(id<NSDKMKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<NSDKMKotlinSuspendFunction1>)visitor suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__50__joinDispatchReceiver:(id<NSDKMKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__join(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__51__invokeDispatchReceiver:(id<NSDKMKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
+ (void)Skie_Suspend__52__bodyDispatchReceiver:(NSDKMKtor_client_coreHttpClientCall *)dispatchReceiver info:(NSDKMKtor_utilsTypeInfo *)info suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__body(dispatchReceiver:info:suspendHandler:)")));
+ (void)Skie_Suspend__53__bodyNullableDispatchReceiver:(NSDKMKtor_client_coreHttpClientCall *)dispatchReceiver info:(NSDKMKtor_utilsTypeInfo *)info suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__bodyNullable(dispatchReceiver:info:suspendHandler:)")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
+ (void)Skie_Suspend__54__getResponseContentDispatchReceiver:(NSDKMKtor_client_coreHttpClientCall *)dispatchReceiver suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__getResponseContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__55__invokeDispatchReceiver:(id<NSDKMKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(NSDKMSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__invoke(dispatchReceiver:p1:suspendHandler:)")));
@end
